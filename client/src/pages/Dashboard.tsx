        ...
        <div style={{ position: "relative", marginTop: 22 }}>
          <div style={{
            ...
            <div style={{ marginTop: 28, display: "flex", flexDirection: "row", gap: 10 }}>
              ...
              {/* Ciemny z niebieską ramką — Nowa umowa */}
              <button
                ...
                style={{
                  ...
                  boxShadow: "inset 0 1px 0 rgba(255,255,255,0.06), 0 3px 0 rgba(10,30,120,0.70), 0 8px 20px rgba(37,99,235,0.25)",
                  position: "relative", overflow: "hidden",
                  transition: "transform 0.15s ease",
                  display: "flex", alignItems: "center", justifyContent: "center", gap: 6,
                }}
              >
                <ArrowUpRight size={15} style={{ color: "#60a5fa" }} />

...
function Spinner() {
  return (
    <div style={{
      ...
      border: `2px solid ${palette.alpha(palette.ink.white, 0.15)}`,
      borderTopColor: palette.loss.base,
  ...
  return (
    <ResellLayout>
      <div style={{ padding: "28px 24px 80px", maxWidth: 860, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24, flexWrap: "wrap", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{
              ...
              background: `linear-gradient(135deg,${palette.sectionAccent.rose.base},${palette.sectionAccent.rose.deep})`,
              display: "flex", alignItems: "center", justifyContent: "center",
            }}>
              <Crosshair size={20} color={palette.ink.white} />
            </div>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <h1 style={{ color: palette.ink.white, fontSize: 22, fontWeight: 900, margin: 0 }}>Śledzenie Rywali</h1>
                {alertCount > 0 && (
                  <span style={{
                    background: palette.sectionAccent.rose.base, color: palette.ink.white, fontWeight: 800, fontSize: 11,
              ...
              <div style={{ color: palette.alpha(palette.ink.white, 0.35), fontSize: 12, marginTop: 2 }}>
                ...
                {alertCount > 0 && (
                  <span style={{ color: palette.loss.base, fontWeight: 700 }}> · {alertCount} rywal taniej!</span>
                )}
              </div>
            </div>
          </div>
            ...
            {items.length > 0 && (
              <button
                ...
                style={{
                  ...
                  borderRadius: 10, border: `1px solid ${palette.alpha(palette.loss.base, 0.3)}`,
                  background: palette.alpha(palette.loss.base, 0.1), color: palette.loss.base,
        ...
        {!hasKeys && (
          <div style={{
            background: palette.alpha(palette.brand.amber, 0.07), border: `1px solid ${palette.alpha(palette.brand.amber, 0.3)}`,
            borderRadius: 12, padding: "12px 16px", marginBottom: 20,
            display: "flex", alignItems: "center", gap: 10,
          }}>
            <AlertTriangle size={16} color={palette.brand.amber} style={{ flexShrink: 0 }} />
            <div style={{ color: palette.brand.goldSoft, fontSize: 13 }}>
              Brak kluczy eBay API.{" "}
              <span style={{ color: palette.alpha(palette.ink.white, 0.5), fontSize: 12 }}>
        ...
        {showForm && (
          <div style={{
            background: palette.alpha(palette.sectionAccent.rose.base, 0.05), border: `1px solid ${palette.alpha(palette.sectionAccent.rose.base, 0.25)}`,
            borderRadius: 14, padding: 18, marginBottom: 20,
          }}>
            <div style={{ color: palette.sectionAccent.rose.soft, fontSize: 13, fontWeight: 700, marginBottom: 14 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 10 }}>
              ...
              <div>
                <div style={{ color: palette.alpha(palette.ink.white, 0.4), fontSize: 10, fontWeight: 700, marginBottom: 5 }}>TWOJA CENA (USD) *</div>
                <input
              ...
              <button
                ...
                style={{
                  ...
                  background: formName.trim() && formQuery.trim() && formPrice
                    ? `linear-gradient(135deg,${palette.sectionAccent.rose.base},${palette.sectionAccent.rose.deep})`
                    : palette.alpha(palette.ink.white, 0.08),
                  color: palette.ink.white, fontWeight: 700, fontSize: 13,
        ...
        {items.length === 0 && !showForm && (
          <div style={{ textAlign: "center", padding: "64px 0" }}>
            <Crosshair size={48} style={{ margin: "0 auto 16px", display: "block", opacity: 0.1, color: palette.sectionAccent.rose.base }} />
            <div style={{ color: palette.alpha(palette.ink.white, 0.3), fontSize: 16, fontWeight: 600, marginBottom: 8 }}>
              Brak śledzonych produktów
            </div>
            <div style={{ color: palette.alpha(palette.ink.white, 0.2), fontSize: 13, maxWidth: 360, margin: "0 auto 24px" }}>
            ...
            <button
              ...
              style={{
                ...
                background: `linear-gradient(135deg,${palette.sectionAccent.rose.base},${palette.sectionAccent.rose.deep})`,
                color: palette.ink.white, fontWeight: 700, fontSize: 13, cursor: "pointer",
              }}
            >
                ...
                <div
                  ...
                  style={{
                    ...
                    border: item.belowMyPrice
                      ? `1px solid ${palette.alpha(palette.sectionAccent.rose.base, 0.35)}`
                      : `1px solid ${palette.alpha(palette.ink.white, 0.08)}`,
                  ...
                  <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 4 }}>
                        <span style={{ color: palette.ink.white, fontWeight: 800, fontSize: 15 }}>{item.name}</span>
                        <span style={{
                          padding: "2px 8px", borderRadius: 99, fontSize: 10, fontWeight: 700,
                          background: palette.alpha(palette.ink.white, 0.06), color: palette.alpha(palette.ink.white, 0.35),
                        }}>
                          {marketLabel}
                        </span>
                      </div>
                      ...
                      {/* Query */}
                      <div style={{ color: palette.alpha(palette.ink.white, 0.3), fontSize: 12, marginBottom: 8 }}>
                      ...
                      <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center", marginBottom: 8 }}>
                        {/* My price */}
                        <div style={{
                          background: palette.alpha(palette.ink.white, 0.05), border: `1px solid ${palette.alpha(palette.ink.white, 0.09)}`,
                          borderRadius: 8, padding: "6px 10px",
                        }}>
                          <div style={{ color: palette.alpha(palette.ink.white, 0.3), fontSize: 9, fontWeight: 700 }}>TWOJA CENA</div>
                          <div style={{ color: palette.ink.white, fontWeight: 900, fontSize: 16 }}>${item.myPrice.toFixed(2)}</div>
                        </div>

                        {/* Competitor lowest */}
                        {hasResult && item.lowestFound !== undefined && (
                          <>
                            <div style={{ color: palette.alpha(palette.ink.white, 0.2), fontSize: 18 }}>vs</div>
                            <div style={{
                              background: item.belowMyPrice ? palette.alpha(palette.sectionAccent.rose.base, 0.1) : palette.alpha(palette.profit.base, 0.08),
                              border: item.belowMyPrice ? `1px solid ${palette.alpha(palette.sectionAccent.rose.base, 0.25)}` : `1px solid ${palette.alpha(palette.profit.base, 0.2)}`,
                              borderRadius: 8, padding: "6px 10px",
                            }}>
                              <div style={{ color: palette.alpha(palette.ink.white, 0.3), fontSize: 9, fontWeight: 700 }}>RYWAL NAJTANIEJ</div>
                              <div style={{ color: item.belowMyPrice ? palette.loss.base : palette.profit.base, fontWeight: 900, fontSize: 16 }}>
                        ...
                        {hasResult && item.avgFound !== undefined && (
                          <div style={{
                            ...
                            <div style={{ color: palette.alpha(palette.ink.white, 0.3), fontSize: 9, fontWeight: 700 }}>ŚR. SPRZEDANE</div>
                            <div style={{ color: palette.ai.base, fontWeight: 800, fontSize: 14 }}>${item.avgFound.toFixed(2)}</div>
                          </div>
                        )}
                      </div>
                      ...
                      {hasResult && (
                        <>
                          {item.belowMyPrice && diff !== null ? (
                            <div style={{ display: "flex", alignItems: "center", gap: 6, color: palette.loss.base, fontSize: 13, fontWeight: 700 }}>
                              <AlertTriangle size={14} />
                              Rywal taniej o ${Math.abs(parseFloat(diff)).toFixed(2)} — rozważ obniżkę ceny
                            </div>
                          ) : (
                            <div style={{ display: "flex", alignItems: "center", gap: 6, color: palette.profit.base, fontSize: 12, fontWeight: 600 }}>
                              <CheckCircle size={13} />
                      ...
                      <div style={{ marginTop: 6, display: "flex", gap: 12, flexWrap: "wrap" }}>
                        <span style={{ color: palette.alpha(palette.ink.white, 0.2), fontSize: 11 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 6, flexShrink: 0, alignItems: "flex-end" }}>
                      <button
                        ...
                        style={{
                          ...
                          border: `1px solid ${palette.alpha(palette.sectionAccent.rose.base, 0.3)}`, background: palette.alpha(palette.sectionAccent.rose.base, 0.1),
                          color: palette.loss.base, fontSize: 11, fontWeight: 700,
                      ...
                      <button
                        ...
                        style={{ background: "none", border: "none", cursor: "pointer", color: palette.alpha(palette.loss.base, 0.3), padding: 4 }}
                        title="Usuń"
                      >
                        <Trash2 size={13} />
                      </button>
        ...
        {items.length > 0 && (
          <div style={{
            ...
            background: palette.alpha(palette.ink.white, 0.02), border: `1px solid ${palette.alpha(palette.ink.white, 0.06)}`, borderRadius: 10,
          }}>
            <div style={{ color: palette.alpha(palette.ink.white, 0.25), fontSize: 10, fontWeight: 700, letterSpacing: 0.8, marginBottom: 6 }}>
              JAK TO DZIAŁA
            </div>
      ...
      {toast && (
        <div style={{
          ...
          background: toast.type === "err" ? palette.alpha(palette.sectionAccent.rose.base, 0.95) : palette.alpha(palette.profit.strong, 0.92),
